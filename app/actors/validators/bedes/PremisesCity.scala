...
object PremisesCity extends BedesValidatorCompanion {
  ...
  def props(guid: String,
    ...
    Props(new PremisesCity(guid, name, propertyId, validatorCategory, arguments))
}
...
/**
  ...
  */
case class PremisesCity(guid: String,
                                name: String,
                                propertyId: String,
                                validatorCategory: Option[String],
