 ...
 */
define(['angular', 'building-life-cycle', 'maalka-templates'], function(angular) {
  'use strict';

  // We must already declare most dependencies here (except for common), or the submodules' routes
  // will not be resolved
  return angular.module('app', ['buildingLifeCycle.dashboard', 'matchmedia-ng', 'maalka-templates']).config(['matchmediaProvider', function (matchmediaProvider) {
